...
function App() {
  ...
  return (
    <div className="container mx-auto app bg-white dark:bg-[#242424]">
      <Analyzer />
      <footer className="mt-4 flex w-full flex-col flex-wrap items-center justify-center gap-y-2 gap-x-12 border-blue-gray-50 text-center dark:text-white text-black transition-all mb-8">
